...
const PanelContent = ({
  ...
  <>
    ...
    <div className="mb-4 border-b border-gray-200 pb-3">
      ...
      <p className="text-xs text-gray-500">Interactive Configuration Panel</p>
    </div>
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2">
          {(['matrix', 'multicolor', 'single', 'opacity'] as variantType[]).map(
            (v) => (
              <button
                key={v}
...
const App = () => {
  ...
  return (
    <div className="min-h-dvh">
      {/* Desktop sidebar: fixed, only visible on md+ */}
      <div className="fixed top-4 left-4 z-30 hidden w-72 md:block">
      ...
      >
        <div className="flex min-h-dvh flex-col md:flex-row">
          {/* Mobile panel: inside the background, at the top, only on small screens */}
          <div className="w-full px-4 pt-4 pb-2 md:hidden">
          ...
          {/* Hero content area */}
          <div className="flex flex-1 items-center justify-center px-4 py-6 sm:px-6 md:min-h-dvh md:py-12 md:pl-80">
